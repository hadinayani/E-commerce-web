        ...
        <div className="max-w-7xl mx-auto p-4 sm:p-6">
            ...
            {!orderDetails ? (
                ...
                <div className="p-4 sm:p-6 rounded-lg border">
                        ...
                        <table className="min-w-full text-gray-600 mb-4 text-center">
                            <thead className="bg-gray-100">
                                <tr>
                                    ...
                                    <th className="py-2 mx-4">Unit Price</th>
                                    <th className="py-2 mx-4">Quantity</th>
                                    <th className="py-2 mx-4">Total</th>
                                </tr>
                            </thead>
                            <tbody>
                    ...
                    <Link to='/my-order' className="hover:text-blue-500 font-medium hover:underline">Back to My Orders</Link>
                </div>
            )}
        </div>
    )
